...
class Delaunay {
    ...
    CopyOnWriteArrayList<PVector> vertices;    
    CopyOnWriteArrayList<Tetrahedron> tetras;  

    public CopyOnWriteArrayList<Line> edges;

    public CopyOnWriteArrayList<Line> surfaceEdges;
    public CopyOnWriteArrayList<Triangle> triangles;
